...
env
do_shell_fail newman run --env-var Server=bayard --env-var Port=:443 --env-var Api=api/multiv2/sometestdomain --insecure src/test/resources/SCIM_Tests.postman_collection.json --reporters cli,junit --reporter-junit-export "build/test-results/TEST-postman-newman.xml"
